...
%Document generated using DScaffolding from https://www.mindmeister.com/1326987278
...
A major problem is that Few attendees in SPLC. This problem is of particular concern as it is now well established that it can lead to No longer CORE A \cite{Teruel2018} and Low visibility. Too nice banquet can be a contributing factor to this problem. 
